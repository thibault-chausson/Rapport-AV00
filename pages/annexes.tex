...
\noindent Alors n'attendez plus, venez vite vous inscrire en équipe dans les listes de la battle de soirées \emoji{partying-face}.
...
Si tu as des questions n'hésite pas à nous contacter \emoji{envelope-with-arrow}.

[L'\gls{AE} en réel ep.5]

Bienvenue au Foyer, le lieu de vie du campus de Belfort \emoji{waving-hand}.

Tu pourras découvrir tout ce qu'on peut faire au Foyer \emoji{winking-face} (oui, oui, ce n'est pas qu'un lieu pour faire des soirées \emoji{party-popper}).
...
\begin{figure}[!h]
    \begin{center}
        ...
        \caption{Post Instagram \gls{PDF} 5/5 \label{fig:pdf5}}
    \end{center}
\end{figure}
